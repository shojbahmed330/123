...
const getDefaultHtml = (appName: string) => `<div id="root">
  <div class="w-full h-full flex flex-col items-center justify-center p-8 bg-[#09090b] text-center space-y-8 relative overflow-hidden min-h-screen">
    ...
    <AuthenticatedLayout user={user} path={path} mode={mode} navigateTo={navigateTo}>
      {mode === AppMode.HELP ? (
        ...
        <ProjectsView 
          ...
          onCreateNew={(n) => db.saveProject(user.id, n, { 'index.html': getDefaultHtml(n) }, { appName: n, packageName: 'com.' + n.toLowerCase() })} 
        />
      ) : (
        <DashboardView 
