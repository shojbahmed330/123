...
const AppConfigView: React.FC<AppConfigViewProps> = ({ config, onUpdate, onBack }) => {
  ...
  const aiModels = [
    ...
    { id: 'deepseek/deepseek-chat-v3-0324', name: 'DeepSeek V3 0324 (OpenRouter)' },
        ...
        <div className="glass-tech p-8 rounded-[3rem] border-pink-500/20 bg-gradient-to-br from-pink-600/5 to-transparent space-y-6">
           <div className="flex items-center justify-between">
              ...
              <button 
                ...
                className="p-3 bg-white/5 rounded-2xl text-zinc-500 hover:text-white transition-all flex items-center gap-2 hidden"
              >
                <HelpCircle size={18}/>
