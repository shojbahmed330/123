...
5. **STRICT REACT HOOKS & COMPONENTS (CRITICAL):**
...
6. **NO DELETIONS:** Never delete existing features or styles unless explicitly asked.`;
...
export const DESIGN_SYSTEM = `### 🎨 DESIGN SYSTEM GUIDELINES:
...
export const PATCH_MODE_RULE = `### 🔧 PATCH MODE (WHEN EDITING EXISTING FILES):
...
export const PLANNING_PROMPT = `You are the "Architect Model". Your task is to create a detailed technical plan for the requested feature.
Focus on:
...
export const CODING_PROMPT = `You are the "Developer Model". Your task is to implement the provided technical plan.
...
export class GeminiService implements AIProvider {
  public extractBalancedJsonBlock(input: string): string | null {
